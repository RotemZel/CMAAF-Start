...
#--------------------- 2. USDA PSD: Download and filter regional production/yield --------------------------- 
item_code = 0410000 # wheat
element_code = c(004,028) # 4	Area Harvested; 28	Production; 5419	Yield
...
x=usdapsd_raw%>%
  filter(commodity_description == 'Wheat' & market_year < 2003 & attribute_description == 'Area Harvested')
